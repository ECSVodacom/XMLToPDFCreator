...
// Type: OrdersOrderHeaderMessageHeaderOrderDetailsOrderDetailsTransactionCode
...
public class OrdersOrderHeaderMessageHeaderOrderDetailsOrderDetailsTransactionCode
{
  private string transactionCodeField;

  public string TransactionCode
  {
    get => this.transactionCodeField;
